...
export const MATCHES = [
  ...
  // ── Round of 32 ── (match numbers 73–88; teams set per official FIFA draw)
  k("r32", "2026-06-28", "2:00 PM", "Los Angeles", "South Africa", "Canada"),
  k("r32", "2026-06-29", "12:00 PM", "Boston", "Germany", "Paraguay"),
  k("r32", "2026-06-29", "3:30 PM", "Monterrey", "Netherlands", "Morocco"),
  k("r32", "2026-06-29", "8:00 PM", "Houston", "Brazil", "Japan"),
  k("r32", "2026-06-30", "4:00 PM", "New York / New Jersey", "France", "Sweden"),
  k("r32", "2026-06-30", "12:00 PM", "Dallas", "Ivory Coast", "Norway"),
  k("r32", "2026-06-30", "8:00 PM", "Mexico City", "Mexico", "Ecuador"),
  k("r32", "2026-07-01", "11:00 AM", "Atlanta", "England", "DR Congo"),
  k("r32", "2026-07-01", "7:00 PM", "San Francisco Bay Area", "USA", "Bosnia and Herzegovina"),
  k("r32", "2026-07-01", "3:00 PM", "Seattle", "Belgium", "Senegal"),
  k("r32", "2026-07-02", "6:00 PM", "Toronto", "Portugal", "Croatia"),
  k("r32", "2026-07-02", "2:00 PM", "Los Angeles", "Spain", "Austria"),
  k("r32", "2026-07-02", "10:00 PM", "Vancouver", "Switzerland", "Algeria"),
  k("r32", "2026-07-03", "1:00 PM", "Miami", "Argentina", "Cabo Verde"),
  k("r32", "2026-07-03", "5:00 PM", "Kansas City", "Colombia", "Ghana"),
  k("r32", "2026-07-03", "8:30 PM", "Dallas", "Australia", "Egypt"),

  // ── Round of 16 ── (slots fill in as Round of 32 winners are decided)
  k("r16", "2026-07-04", "4:00 PM", "Philadelphia", "Paraguay", null),
  k("r16", "2026-07-04", "12:00 PM", "Houston", "Canada", "Morocco"),
  k("r16", "2026-07-05", "3:00 PM", "New York / New Jersey", "Brazil", null),
